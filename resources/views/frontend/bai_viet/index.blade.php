                        ...
                        @foreach ($tintucs as $item )
                         ...
                         <div class="col-12">
                            <div class="blog__type-list">
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="blog__img"><a href="#"><img src="{{pare_url_file($item->hinhanh)}}" alt=""></a></div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="blog__content">
                                            <a class="link--gray" href="#"><h3 class="blog__title">{{$item->tieude}}</h3></a>
                                            <div class="blog__archive m-t-20">
                                                <a href="#" class="link--gray link--icon-left m-r-30"><i class="far fa-calendar"></i> {{$item->thoigiandang}}</a>
                                            </div>
