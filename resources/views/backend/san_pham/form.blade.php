    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <label for="exampleInputTenLoaiDoUong">Tên sản phẩm</label>
            ...
            <div class="form-group">
                <label for="exampleInputLoaiDoUong">Loại sản phẩm</label>
                <select name="loaisanpham_id" id="" class="form-control" aria-describedby="loaidouongHelp">
                ...
                <small id=" loaidouongHelp" class="form-text text-danger">{{$errors->first('loaisanpham_id')}}</small>
                @endif
            </div>
        ...
        @if(\Request::route()->getName()=='get_backend.san_pham.create')
            <button type="submit" class="btn btn-primary mb-5">Thêm mới</button>
        @elseif (\Request::route()->getName()=='get_backend.san_pham.update')
